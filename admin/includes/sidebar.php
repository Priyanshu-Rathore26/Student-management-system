...
{               ?>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="manage-request.php">Requests</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#autha" aria-expanded="false" aria-controls="auth">
