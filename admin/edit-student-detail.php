...
<option value="<?php echo htmlentities($row1->ClassName);?><?php echo htmlentities($row1->Section);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="div-img"><img src="images/<?php echo $row->Image;?>" value="<?php  echo  $row->Image;?>"></div>
                      </div> 
...
<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="password" value="<?php  echo htmlentities($row->Password);?>" class="form-control" readonly='true'>
                      </div><?php $cnt=$cnt+1;}} ?>
