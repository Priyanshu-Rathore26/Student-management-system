...
?>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <?php 
                        $sql3 ="SELECT * from  tblnotice WHERE N0A1=0";
...
?>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <?php 
                        $sql3 ="SELECT * from  tblnotice WHERE N0A1=1" ;
$query3 = $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$totnotice=$query3->rowCount();
?>
                          <span class="report-title">Total Class Assignment</span>
                          <h4><?php echo htmlentities($totnotice);?></h4>
                          <a href="manage-assignment.php"><span class="report-count"> View Assignment</span></a>
                        </div>
                        <div class="inner-card-icon bg-warning">
                          <i class="icon-doc"></i>
                        </div>
...
$totnotice=$query3->rowCount();
?>
                          <span class="report-title">Search Student</span>
                          <h4></h4>
                          <a href="search.php"><span class="report-count">Search</span></a>
                        </div>
                        <div class="inner-card-icon bg-success">
