...
$sql="SELECT tblclass.ID,tblclass.ClassName,tblclass.Section,tblnotice.NoticeTitle,tblnotice.CreationDate,tblnotice.ClassId,tblnotice.ID as nid from tblnotice join tblclass on tblclass.ID=tblnotice.ClassId WHERE tblnotice.N0A1=0 LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
                          ...
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-notice-detail.php?editid=<?php echo htmlentities ($row->nid);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-notice.php?delid=<?php echo ($row->nid);?>" class="btn_del"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
